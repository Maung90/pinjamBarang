    $(document).ready(function () {
        ...
        $('#dataTableUser').DataTable({
            ...
            buttons: [
                {
                    text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add New Feature</span>',
            ...
            scrollX: true,
            ajax: basePath + 'ec6b5ec2-99b8-4627-82c0-376b2007a007',
            dataType: 'json',
            columns: [
