    $(document).ready(function () {
        ...
        $('#dataTableUser').DataTable({
            ...
            buttons: [
                {
                    text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add New Script</span>',
            ...
            scrollX: true,
            ajax: basePath + '6e98be80-cba5-4a7e-abfd-961eac743ac3',
            dataType: 'json',
            columns: [
